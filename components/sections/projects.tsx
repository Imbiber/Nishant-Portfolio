      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <Card
              key={project.id}
              className={`bg-gradient-to-br from-gray-900/50 to-black/50 border backdrop-blur-xl overflow-hidden transition-all duration-500 transform hover:scale-105 group ${
                project.featured
